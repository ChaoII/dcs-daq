...
void AGraphicsView::draw_real_rect(const QString &tag_id, const QString &tag_name, const QRectF &rect, bool is_manual) {
    temp_canvas_->clear();
    auto rect_item = new ARectItem(tag_id, tag_name, rect);
